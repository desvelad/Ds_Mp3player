...
async def update_admin(client, message):
    ...
    await message.reply_text('Başarıyla güncelleştirildi yönetici listesi **{}**'.format(message.chat.title))
...
async def resume(_, message: Message):
    if (
        ...
        await message.reply_text("❗ Hiçbir şey akıyor!")
    else:
...
async def admincache(client, message: Message):
    ...
    #await message.reply_text("✯𝗩𝗖𝗣𝗹𝗮𝘆𝗕𝗼𝘁✯=❇️ Yönetici önbelleği yenilendi!")
